...
import 'package:icaleg/presentation/login_verification/controllers/login_verification.controller.dart';
import 'package:pinput/pinput.dart';

class LoginVerificationFormView extends GetView {
  LoginVerificationFormView({Key? key}) : super(key: key);

  @override
  final LoginVerificationController controller =
      ...
      child: Column(
        ...
        children: [
          ...
          RichText(
            ...
            TextSpan(
              text: 'Kami telah mengirimkan OTP ke Nomor Whatsapp anda ',
              style: TextStyle(color: colorTextGray),
            ),
            TextSpan(
                text: controller.nomorWa,
